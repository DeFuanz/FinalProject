...
import com.example.finalproject.network.Movie
import com.example.finalproject.utils.MovieContentType
    ...
    when (movieViewModel.movieUiState) {
        ...
        is MovieUiState.Success -> {
            when (contentType) {
                ...
                MovieContentType.lIST_WITH_DETAIL -> MovieListDetailAdaptive(
                    movies = (movieViewModel.movieUiState as MovieUiState.Success).movies,
                    onMovieClick = {
                        movieViewModel.updateCurrentMovie(it)
                    },
...
fun MovieListPreview() {
    MovieList(movies = listOf(Movie(title = "The Godfather", poster = "", description = "The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.", releaseDate = "1972-03-24", contentRating = "R", reviewScore = "9.2", bigImage = "", length = "2h 55min"), Movie(title = "The Godfather", poster = "", description = "The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.", releaseDate = "1972-03-24", contentRating = "R", reviewScore = "9.2", bigImage = "", length = "2h 55min"), Movie(title = "The Godfather", poster = "", description = "The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.", releaseDate = "1972-03-24", contentRating = "R", reviewScore = "9.2", bigImage = "", length = "2h 55min"), Movie(title = "The Godfather", poster = "", description = "The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.", releaseDate = "1972-03-24", contentRating = "R", reviewScore = "9.2", bigImage = "", length = "2h 55min"), Movie(title = "The Godfather", poster = "", description = "The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.", releaseDate = "1972-03-24", contentRating = "R", reviewScore = "9.2", bigImage = "", length = "2h 55min"), Movie(title = "The Godfather", poster = "", description = "The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.", releaseDate = "1972-03-24", contentRating = "R", reviewScore = "9.2", bigImage = "", length = "2h 55min")), onMovieClick = {}, modifier = Modifier)
}

@Preview
@Composable
fun MovieDetailPreview() {
    MovieDetailScreen(selectedMovie = Movie(title = "The Godfather", poster = "", description = "The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.", releaseDate = "1972-03-24", contentRating = "R", reviewScore = "9.2", bigImage = "", length = "2h 55min"), onBackPressed = { /*TODO*/ }, contentPadding = PaddingValues(0.dp), modifier = Modifier)
}
